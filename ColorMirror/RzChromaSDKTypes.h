...
namespace ChromaSDK
{
    ...
    typedef enum EFFECT_TYPE
    {
        ...
        CHROMA_CUSTOM,              //!< Custom effect 1. Currently only applies to Keyboards. ChromaSDK::Keyboards::CUSTOM_GRID_EFFECT_TYPE
    ...
    namespace Mouse
    {
        ...
        typedef enum RZLED
        {
            ...
            RZLED_BACKLIGHT     = 0x0003,   //!< Backlight or numpad (Naga Epic)
